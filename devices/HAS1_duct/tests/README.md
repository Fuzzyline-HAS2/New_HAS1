...
The duration table targets `HAS2-Nextion` branch `feat/audio-library-v2`, `audios/V2/duct_MP3_22k/01~08`; its source commit is recorded in the header. Durations are WAV frame counts divided by the sample rate, rounded up to milliseconds. The scheduler adds its existing 200ms margin separately.
